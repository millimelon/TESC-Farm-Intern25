...
func main() {
	...
	r.GET("/crop/:id/preharvests", harvest.GetCropPlantings)
	...
	r.POST("/planting/:id/update", harvest.UpdatePlanting)
	r.POST("/planting/:id/delete", harvest.DeletePlanting)
	r.POST("/planting/new", harvest.AddPlanting)
